document.addEventListener('DOMContentLoaded', function () {
    ...
    const quizData = [
        ...
        {
            id: "q4",
            question: "Simbol untuk selektor ID pada CSS adalah...",
            options: {
                A: ".", (Titik)
                B: "#", (Pagar)
                C: "@", (At)
    ...
    correctAnswer: "B",
    explanation: "Dalam CSS, simbol <b>#</b> (pagar) digunakan untuk memilih elemen berdasarkan ID, sedangkan simbol <b>.</b> (titik) digunakan untuk Class."
        },
    {
        id: "q5",
